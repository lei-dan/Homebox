...
function EnhancedTableHead({ cells, classes, order, orderBy, onRequestSort }) {
...
export default function CustomTable({ data, headCells, orderByKey }) {
